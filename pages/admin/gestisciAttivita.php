			...
			<tbody>
				<?php foreach($result as $row): ?>
					<tr class="hover:bg-gray-50">
						...
						<td class="border border-gray-300 px-4 py-2">
							<form action="../../utils/attivita/rimuovi.php" method="POST" class="inline">
				...
				<tr>
					<td colspan="2" class="text-center border border-gray-300 px-4 py-2">
						<button id="mostra-form" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">+ Aggiungi nuova Attività</button>
					</td>
				</tr>
		...
		document.getElementById('mostra-form').addEventListener('click', function () {
			...
			formRow.innerHTML = `
				<td colspan="2" class="border border-gray-300 px-4 py-2">
					<form action="../../utils/attivita/aggiungi.php" method="POST" class="flex gap-4 justify-center">
						<input type="text" name="nome" placeholder="Attività" required class="border border-gray-300 rounded px-2 py-1">
